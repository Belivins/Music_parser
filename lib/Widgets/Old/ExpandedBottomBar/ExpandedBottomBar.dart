  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, layoutConstraints) {
        ...
        //     constraints.maxHeight - viewPadding.vertical - 100;
        final finalHeight = widget.expandedHeight;
          ...
          children: <Widget>[
                ...
                children: [
                  Container(
                    ...
                    decoration: widget.expandedDecoration ??
                        BoxDecoration(
                          color: _controller!.isClosed ? widget.expandedBackColor :
                              Colors.transparent,
                          // borderRadius: BorderRadius.circular(25),
                        ),
                    child: Opacity(
                        opacity: panelState > 0.1 ? 1 : panelState * 4,
                        // opacity: 1,
            ...
            ClipPath(
              ...
              child: Container(
                ...
                height: panelState > 0.1 ? 0 : widget.appBarHeight + viewPadding.vertical + 20,
                child: Visibility(
                  visible: panelState > 0.1 ? false : true,
                  child: Container(
