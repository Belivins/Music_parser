...
class CustomSilverList extends StatefulWidget{
  ...
  const CustomSilverList(this.audioHandler, {Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CustomSilverList();
}

class _CustomSilverList extends State<CustomSilverList>{
                      ...
                      InkWell(
                        ...
                        child: Row(
                          children: [
                            ...
                            //             (findMusic[index].name == widget.audioHandler.mediaItem.value!.title ||
                            //             findMusic[index].author == widget.audioHandler.mediaItem.value!.artist)) {
                            //           return Icon(Icons.pause, size: 36,);
                            //         } else {
